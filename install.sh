...
echo -e "  ${INSTALL_DIR}/gowa-manager                                    # Start with defaults"
echo -e "  ${INSTALL_DIR}/gowa-manager --port 8080                       # Custom port"
echo -e "  ${INSTALL_DIR}/gowa-manager -u myuser -P mypass               # Custom credentials"
echo -e "  ${INSTALL_DIR}/gowa-manager --data-dir /path/to/data          # Custom data directory"
echo -e "  ${INSTALL_DIR}/gowa-manager --help                            # Show help"
echo ""
echo -e "${BLUE}Then open: ${GREEN}http://localhost:3000${NC} ${BLUE}(or custom port)${NC}"
echo -e "${BLUE}Default login: ${GREEN}admin/password${NC}"
echo ""
echo -e "${BLUE}Command line options:${NC}"
echo -e "  -p, --port <port>              Server port (default: 3000)"
echo -e "  -u, --admin-username <user>    Admin username (default: admin)"
echo -e "  -P, --admin-password <pass>    Admin password (default: password)"
echo -e "  -d, --data-dir <path>          Data directory (default: ./data)"
